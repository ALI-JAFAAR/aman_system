...
return [
    ...
    // In local/dev environments, we may not always have the DB running when generating docs.
    // Set this to an empty array to skip DB transactions during extraction.
